    ...
    return (
        ...
        >
            ...
            <Box sx={{padding: '20px'}}>
                ...
                <TextField onChange={handleHeadingChange} fullWidth required variant="outlined" minRows={1} maxRows={3} defaultValue={heading || ""} sx={{'& .MuiOutlinedInput-root': {backgroundColor: '#F9F6EE', '& fieldset': {border: '0'}, '&:hover': {backgroundColor: '#C0C0C0'}, '&:hover fieldset:': {border: '0'}, '&.Mui-focused fieldset': {border: '0'}}, marginBottom: '20px', marginTop: '4px'}} />

                <h2 className="text-font">Text Content</h2>
                <TextField onChange={handleTextChange} fullWidth required multiline variant="outlined" rows={6} maxRows={6} defaultValue={text || ""} sx={{'& .MuiOutlinedInput-root': {backgroundColor: '#F9F6EE', '& fieldset': {border: '0'}, '&:hover': {backgroundColor: '#C0C0C0'}, '&:hover fieldset:': {border: '0'}, '&.Mui-focused fieldset': {border: '0'}}, marginTop: '4px'}} />
