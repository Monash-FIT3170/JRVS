    ...
    return (
        ...
        >
            ...
            >
                ...
                <Button onClick={handleBackClick} variant="contained" className="button-font" sx={{':hover': {backgroundColor: '#2196F3'}, marginRight: '60px', padding: '15px', borderRadius: '15px', backgroundColor: '#FFC93C', visibility: hasFinishedCarousel || (seenNum === contentBoxes.length) ? 'visible' : 'hidden'}}>RETURN TO LEARNING PATH</Button>
            </Box>
        </Box>
    );
}
