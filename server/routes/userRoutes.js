...
const { createUser, updatePoints, getUserByUsername, getUserById, updateAvatar, updateUnlocked, getAllUsers, getProfile, joinTeacher, updateDetails, updatePassword } = require('../controllers/userController');
